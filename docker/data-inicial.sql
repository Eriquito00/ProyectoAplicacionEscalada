...
INSERT INTO vies (sector_id, tipus_id, ancoratge_id, tipus_roca_id, escalador_id, dificultat_id, nom, llargada, numero_via, orientacio, estat) VALUES
(1, 1, 2, 3, 1, 22, "El repte vertical", 25, 1, "N", "apte"),
(2, 2, 4, 2, 2, 1, "La fissura del vent", 30, 2, "S", "tancada"),
(3, 1, 1, 3, 3, 8, "Somnis de Pedra", 20, 3, "O", "apte"),
(4, 3, 7, 2, 4, 12, "Cascada de Cristall", 50, 4, "NO", "construccio"),
(5, 1, 3, 1, 5, 4, "Diedre Oblicu", 35, 5, "SE", "construccio"),
(3, 2, 5, 4, 1, 9, "L'esquerda infinita", 40, 6, "E", "apte"),
(5, 1, 6, 2, 3, 25, "El sostre del diable", 30, 7, "S", "construccio"),
(4, 3, 8, 5, 4, 8, "Colmillos de hielo", 60, 8, "N", "apte"),
(2, 2, 9, 2, 2, 10, "El regne oblidat", 45, 9, "O", "apte"),
(1, 1, 4, 3, 5, 31, "Mussol nocturn", 28, 10, "NO", "construccio"),
(2, 1, 3, 2, 1, 35, "Via del Drac", 35, 11, "SE", "apte"),
(3, 2, 4, 3, 2, 23, "El mur silencios", 40, 12, "O", "tancada"),
(4, 3, 6, 4, 3, 27, "Gel Eterna", 55, 13, "N", "apte"),
(5, 1, 5, 1, 4, 14, "Fissura amagada", 30, 14, "S", "tancada"),
(1, 2, 7, 3, 5, 18, "El cami de l'aliga", 38, 15, "E", "apte"),
(3, 1, 2, 2, 1, 20, "Cingle misterios", 33, 16, "NO", "construccio"),
(4, 3, 9, 4, 2, 16, "Parets de gel", 60, 17, "O", "apte"),
(5, 2, 8, 5, 3, 22, "El crit de la muntanya", 45, 18, "N", "apte"),
(1, 1, 1, 3, 4, 31, "Verticalitat pura", 28, 19, "SE", "construccio"),
(2, 2, 4, 2, 5, 2, "L'ombra del cim", 50, 20, "S", "tancada");